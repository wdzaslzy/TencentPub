...
public class DemoFunction extends AbstractGenericUDAFResolver {
...
//			return new DoubleGenericUDAF();
    ...
    public static class StringGenericUDAF extends GenericUDAFEvaluator {
        ...
        /**
         * 用于最终处理（Reduce阶段）和返回结果 这时的AggregationBuffer已经合并了Group里所有的元素， 可以进行其他处理，例如文本性别分类就在这里执行。
         */
        @Override
